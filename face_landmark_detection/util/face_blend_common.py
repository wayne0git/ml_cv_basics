...
def calculateDelaunayTriangles(rect, points):
	...
	for t in triangleList:
		# The triangle returned by getTriangleList is a list of 6 coordinates of the 3 points in x1, y1, x2, y2, x3, y3 format.
		...
		if rectContains(rect, pt1) and rectContains(rect, pt2) and rectContains(rect, pt3):
			# Find the index of each triangle vertex in the points list
			ind = []
			for j in range(0, 3):
